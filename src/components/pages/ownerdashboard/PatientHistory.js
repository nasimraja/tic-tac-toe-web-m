...
const PatientHistory = ()=>{
    ...
    const getWinUser = () => {
        ...
        fetch(API + "/win/by/" + Patienthistory,
            {
                method: 'GET',
                headers: {
    ...
    const getLossUser = () => {
        ...
        fetch(API + "/loss/by/" + Patienthistory,
            {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const getwinDaybyid = () => {
        ...
        fetch(API + "/get/winday/" + Patienthistory,
            {
                method: 'GET',
                headers: {
                    'Content-Type': 'application/json',
                ...
                response.json().then((resp) => {
                    ...
                    resp.data.map((v, i) => {
                        _temp.push({
                            ...
                            <li><a href={"/owner/edit/patient/history/" + v.id} className="view-patient">Edit</a></li>
