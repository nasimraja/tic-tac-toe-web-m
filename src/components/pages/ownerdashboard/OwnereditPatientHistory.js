...
const OwnereditPatientHistory = ()=>{
    const {ownereditpatienthistory} = useParams();
    const name = useRef();
    const email = useRef();
    const result = useRef();
    const dates = useRef();
    ...
    const getPatientHistory = () => {
        ...
        fetch(API+"/single/patient/history/" + ownereditpatienthistory,
            {
                method: 'GET',
                headers: {
    ...
    const UpdatePatientHistory = () => {
        ...
        fetch(API+"/updatepatient/byowner/" + ownereditpatienthistory, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
export default OwnereditPatientHistory;